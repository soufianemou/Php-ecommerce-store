...
<section class="flex justify-center items-center h-[calc(100vh-200px)]">
    <div class="text-center">
        <div class="my-8">
            <img src="../assets/img/user.png" alt="" width="100px"  class="mx-auto">
        </div>
        <h2 class="font-bold text-lg"><?php echo $user['fname']; echo " ".$user['lname'] ?></h2>
        <h2 class="mt-2 mb-8 font-bold text-md"><?php echo $user['email']?></h2>
        <div class="flex flex-col gap-3">
            <a class="bg-[green] py-2 px-4 rounded-lg text-white font-bold text-xl" href="./updateAcount.php?id=<?php echo $user['id_user'] ?>">update information</a>
            <a class="bg-[red] py-2 px-4 rounded-lg text-white font-bold text-xl" href="./deleteAccount.php?id=<?php echo $user['id_user'] ?> " onclick="return confirmDeleat(event)">Delete account</a>
        </div>
    </div>
</section>

<script>
function confirmDeleat(event){
