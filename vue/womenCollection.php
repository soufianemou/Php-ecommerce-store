...
?>
    ...
    <section class="py-10 my-8">
        <div class="w-[80%] mx-auto ">
            <h2 class="text-center text-6xl my-14 text-[#FD4112] font-bold tracking-widest underline">Women Collection</h2>
            <div class="grid grid-cols-3 gap-4 ">    
            <?php 
                require('../database/conection.php');
                $sql = "SELECT * FROM product where gender in ('women','both')";
