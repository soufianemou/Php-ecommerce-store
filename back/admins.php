...
<section class="min-h-screen w-full relative ">
    ...
    <main class="bg-white w-[calc(100%-300px)] min-h-screen absolute left-[300px] transition-all duration-700">
        ...
        <section class="p-4 bg-white min-h-screen ">
          <div class="p-3">   
            <a href="./add_admin.php" class="inline-block my-8 text-lg font-medium bg-[#ff7d1a] p-2 text-white hover:text-black rounded-lg">Add Admin</a>                        
                ...
                <table class="w-full text-sm text-center ">
                    ...
                    <tbody>
                      ...
                      <tr class="hover:bg-[#FFD3AC]">
                        <td class="px-6 py-4  font-medium"><?php echo $admin['id'] ?></td>
                        <td class="px-6 py-4  font-medium"><?php echo $admin['username'] ?></td>
                        <td class="px-6 py-4  font-medium"><?php echo $admin['pass'] ?></td>
                        <td class="px-6 py-4  font-medium"><?php echo $admin['date_creation'] ?></td>
                        <td class="px-6 py-4 text-center">
                          <a href="./update_admin.php?id=<?php echo $admin['id'] ?>" class="font-medium me-2"><i class="fa-solid fa-pen-to-square fa-2x" style="color: green;"></i></a>
                          <a href="./delete_admin.php?id=<?php echo $admin['id'] ?>" class="font-medium" onclick="return deleteAdmin(event)">
